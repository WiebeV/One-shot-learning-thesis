...
param_str = f'{args.dataset}_order={args.order}_n={args.n}_k={args.k}_metabatch={args.meta_batch_size}_' \
            f'train_steps={args.inner_train_steps}_val_steps={args.inner_val_steps}_experiment={args.experiment_name}'
print(param_str)
...
if args.retrain:
    meta_model.load_state_dict(torch.load(PATH + f'/models/maml/{param_str}.pth'))
