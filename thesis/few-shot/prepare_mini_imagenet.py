...
for c in background_classes:
    mkdir(DATA_PATH + f'/few-shot/images_background/{c}/')

for c in evaluation_classes:
    mkdir(DATA_PATH + f'/few-shot/images_evaluation/{c}/')
...
for root, _, files in os.walk(DATA_PATH + '/few-shot/images'):
    for f in tqdm(files, total=600*100):
        if f.endswith('.jpg'):
            ...
            src = f'{root}/{f}'
            dst = DATA_PATH + f'/few-shot/{subset_folder}/{class_name}/{image_name}'
            shutil.copy(src, dst)
...
# # background_classes, evaluation_classes = classes[:80], classes[80:]
#
# background_classes = ['class_0', 'class_1', 'class_10', 'class_18', 'class_19', 'class_2', 'class_24', 'class_25', 'class_3',
#            'class_4', 'class_5', 'class_6', 'class_7', 'class_8', 'class_9']
#
# evaluation_classes = ['class_test_0', 'class_test_14', 'class_test_14', 'class_test_16', 'class_test_2', 'class_test_3',
#                       'class_test_4', 'class_test_5', 'class_test_6', 'class_test_7']
#
# # # Create class folders
# # for c in background_classes:
